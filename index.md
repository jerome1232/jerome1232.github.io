...
### Projects
  ...
  * **Covid-19 Tracker**:
    * As part of a team of three developed a Covid-19 tracking app for Android using Kotlin.
    * I utilized three JSON api endpoints to find the data requested whether it be a state or country.
